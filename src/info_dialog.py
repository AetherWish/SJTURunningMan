...
"}")
    ...
    def retranslateUi(self, HelpWindow):
        ...
        self.infoLabel.setText(QCoreApplication.translate("HelpWindow", u"<html><head/><body><p>四改：Github@AetherWish</p><p>三改：Github@JackyTJie</p><p>二改：Github@accelerator-s</p><p>原作者：Github@Labyrinth0419</p><p>Version: " + config.global_version + "</p></body></html>", None))
